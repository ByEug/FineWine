...
<div class="admin-order-details-under-head">
    ...
    <div class="admin-order-details-under-head">
        ...
        <h3>
            <c:out value="${order.orderStatus.toString()}"/>
        </h3>
    </div>
</div>
<div class="container">
...
<div>
    ...
    <form method="post" action="${pageContext.request.contextPath}/admin/orders/${order.id}?status=Cancelled">
        <button>
            Cancelled
        </button>
    </form>
    <form method="post" action="${pageContext.request.contextPath}/admin/orders/${order.id}?status=Completed">
        <button>
            Completed
        </button>
    </form>
